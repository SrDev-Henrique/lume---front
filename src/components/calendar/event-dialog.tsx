      ...
      <DialogContent className="sm:max-w-[425px] bg-card backdrop-blur-md">
        <DialogHeader>
          ...
          <DialogDescription className="sr-only">
            {event?.id
              ? "Editar os detalhes deste evento"
        ...
        <div className="grid gap-4 py-4">
          <div className="*:not-first:mt-1.5">
            <Label className="text-primary-foreground" htmlFor="title">
              Título
            </Label>
            <Input
              id="title"
          ...
          <div className="*:not-first:mt-1.5">
            <Label className="text-primary-foreground" htmlFor="description">
              Descrição
            </Label>
            <Textarea
              id="description"
          ...
          <div className="flex gap-4">
            <div className="flex-1 *:not-first:mt-1.5">
              <Label className="text-primary-foreground" htmlFor="start-date">
                Data de Início
              </Label>
            ...
            {!allDay && (
              <div className="min-w-28 *:not-first:mt-1.5">
                <Label className="text-primary-foreground" htmlFor="start-time">
                  Hora de Início
                </Label>
          ...
          <div className="flex gap-4">
            <div className="flex-1 *:not-first:mt-1.5">
              <Label className="text-primary-foreground" htmlFor="end-date">
                Data de Término
              </Label>
            ...
            {!allDay && (
              <div className="min-w-28 *:not-first:mt-1.5">
                <Label className="text-primary-foreground" htmlFor="end-time">
                  Hora de Término
                </Label>
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <Label className="text-primary-foreground" htmlFor="all-day">
              Dia todo
            </Label>
          </div>

          <div className="*:not-first:mt-1.5">
            <Label className="text-primary-foreground" htmlFor="location">
              Local
            </Label>
            <Input
              id="location"
          ...
          <fieldset className="space-y-4">
            <legend className="font-medium text-primary-foreground text-sm leading-none">
              Etiqueta
            </legend>
            <RadioGroup
